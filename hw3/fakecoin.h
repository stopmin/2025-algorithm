...
void load_coins() {
    in = fopen("/Users/jeongjimin/Documents/pusan-univ/2025년/1학기/알고리즘/hw3/sample_data/01.inp", "r");
...
void report_coin(int i) {
    out = fopen("/Users/jeongjimin/Documents/pusan-univ/2025년/1학기/알고리즘/hw3/sample_data/01.out", "w");
    fprintf(out, "%d", i);
    exit(0);
}
